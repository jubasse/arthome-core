...
export function reminderInstantFor(startsAt) {
...
export function isWithinQuietHours(instant, viewerUtcOffsetMinutes) {
 ...
 */
export function shouldDeliverNow(instant, viewerUtcOffsetMinutes, isHeldSeatLiveStart) {
 ...
 */
export function mayCarryAmount(recipientCanRevenue) {
 ...
 */
export function reminderStillValid(scheduledFor, currentStartsAt) {
