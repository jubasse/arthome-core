...
import { venueClock } from '../time/venue-clock.js';
...
const EUR = (amountMinor) => money(amountMinor, 'EUR');
function tiers(full) {
    return [
...
function timingAt(startsAt, policy, windowHours) {
    return {
        startsAt,
        runtimeMin: 120,
 ...
 */
export function buildFixtures(seed, clock) {
...
export function fixtureDate(fixtures, id) {
