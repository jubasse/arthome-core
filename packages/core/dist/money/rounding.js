 ...
 * direction.
 */
export function applyRate(value, rate) {
 ...
 * that drifts.
 */
export function remainderAfterRate(value, rate) {
 ...
 */
export function taxIncludedIn(grossTtc, rate) {
    return money(roundMinor((grossTtc.amountMinor * rate) / (BASIS_POINTS_SCALE + rate)), grossTtc.currencyCode);
}
