...
export const PRICE_TIERS = ['full', 'reduced', 'support'];
 ...
 */
export const PLAN_TIERS = ['free', 'pass', 'premium'];
...
export const SUBSCRIPTION_STATES = ['active', 'past_due', 'cancelled', 'trialing'];
...
export const ORDER_KINDS = ['seat', 'merch', 'subscription'];
 ...
 */
export const PAYOUT_STATES = ['scheduled', 'held', 'paid', 'refunded', 'suspended'];
...
export const TAX_JURISDICTION_LEVELS = ['country', 'state', 'county', 'city'];
