 ...
 * renders normally.
 */
export function parseTolerant(vocabulary, raw) {
    return vocabulary.includes(raw)
 ...
 */
export function isMember(vocabulary, raw) {
    return vocabulary.includes(raw);
}
/**
 ...
 */
export function memberOr(vocabulary, raw, fallback) {
    return isMember(vocabulary, raw) ? raw : fallback;
}
//# sourceMappingURL=tolerant.js.map