 ...
 */
export const RUN_STATES = ['idle', 'rehearsal', 'on_air', 'interrupted', 'ended'];
 ...
 */
export const DATE_OUTCOMES = ['postponed', 'cancelled', 'interrupted'];
 ...
 */
export const REPLAY_POLICIES = ['included', 'subscription', 'unit', 'none'];
...
export const RIGHTS_SCOPES = ['worldwide', 'restricted'];
 ...
 */
export const BLACKOUT_REASONS = ['co_production', 'broadcaster', 'festival'];
 ...
 */
export const LANGUAGE_DEPENDENCIES = ['none', 'helpful', 'essential'];
...
export const INCIDENT_KINDS = ['hold_screen', 'postponed', 'cancelled', 'interrupted'];
