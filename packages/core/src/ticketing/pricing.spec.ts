...
describe('the summary, line by line', () => {
  it('carries the four lines, and they close', () => {
    ...
    expect(quote.discount.amountMinor).toBe(780);
    expect(quote.serviceFee.amountMinor).toBe(450);
    expect(quote.total.amountMinor).toBe(7800 - 780 + 450);
  });

  it('rounds the unit price, not the total', () => {
    // €26.37 discounted 12%: the unit is 2637 − round(316.44) = 2321, so 6963
    // for three seats. Discounting the TOTAL would give 6962.
